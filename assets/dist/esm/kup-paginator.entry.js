...
class KupPaginator {
    ...
    render() {
        ...
        return (h("div", { id: "paginator" }, h("div", { class: "align-left" }, "Pagina", h("span", { class: "prev-page" }, h("icon", { className: prevPageClassName, onclick: () => this.onPrevPage() })), h("kup-combo", { items: goToPageItems, isFilterable: false, initialValue: {
                id: this.currentPage,
