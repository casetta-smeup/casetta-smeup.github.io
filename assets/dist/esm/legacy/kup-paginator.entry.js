...
var KupPaginator = /** @class */ (function () {
    ...
    KupPaginator.prototype.render = function () {
        ...
        return (h("div", { id: "paginator" }, h("div", { class: "align-left" }, "Pagina", h("span", { class: "prev-page" }, h("icon", { className: prevPageClassName, onclick: function () { return _this.onPrevPage(); } })), h("kup-combo", { items: goToPageItems, isFilterable: false, initialValue: {
                id: this.currentPage,
            }, onKetchupComboSelected: function (e) { return _this.onPageChange(e); } }), h("span", { class: "next-page" }, h("icon", { className: nextPageClassName, onclick: function () { return _this.onNextPage(); } })), h("span", { class: "number-of-pages" }, "di ", maxNumberOfPage)), h("div", { class: "align-right" }, h("span", { class: "nextPageGroup" }, "Numero risultati: ", this.max), h("slot", { name: "more-results" }), "Mostra", h("kup-combo", { items: rowsPerPageItems, isFilterable: false, initialValue: {
                id: this.perPage,
