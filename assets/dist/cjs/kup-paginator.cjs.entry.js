...
class KupPaginator {
    ...
    render() {
        ...
        return (__chunk_1.h("div", { id: "paginator" }, __chunk_1.h("div", { class: "align-left" }, "Pagina", __chunk_1.h("span", { class: "prev-page" }, __chunk_1.h("icon", { className: prevPageClassName, onclick: () => this.onPrevPage() })), __chunk_1.h("kup-combo", { items: goToPageItems, isFilterable: false, initialValue: {
                id: this.currentPage,
            }, onKetchupComboSelected: (e) => this.onPageChange(e) }), __chunk_1.h("span", { class: "next-page" }, __chunk_1.h("icon", { className: nextPageClassName, onclick: () => this.onNextPage() })), __chunk_1.h("span", { class: "number-of-pages" }, "di ", maxNumberOfPage)), __chunk_1.h("div", { class: "align-right" }, __chunk_1.h("span", { class: "nextPageGroup" }, "Numero risultati: ", this.max), __chunk_1.h("slot", { name: "more-results" }), "Mostra", __chunk_1.h("kup-combo", { items: rowsPerPageItems, isFilterable: false, initialValue: {
                id: this.perPage,
