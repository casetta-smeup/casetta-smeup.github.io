        ...
        return [
            __chunk_1.h("div", { class: containerClass +
                    (this.isClearable
                        ...
                        : ''), ref: (el) => (this.comboText = el) }, __chunk_1.h("span", { class: this.baseClass + '__current-value', onClick: this.onComboClick.bind(this) }, this.selected ? this.selected[this.displayedField] : '', __chunk_1.h("svg", { class: this.baseClass +
                    '__icon ' +
                    this.baseClass +
                    '__chevron' +
                    (this.isOpen
