...
/***/ "./src/assets/dist/esm/legacy/chunk-8cdcd574.js":
/*!******************************************************!*\
  !*** ./src/assets/dist/esm/legacy/chunk-8cdcd574.js ***!
  \******************************************************/
/*! exports provided: P */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "P", function() { return PaginatorMode; });
var PaginatorMode;
...
/*!*****************************************************!*\
  !*** ./src/assets/dist/esm/legacy/kup-box.entry.js ***!
  \*****************************************************/
/*! exports provided: kup_box */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "kup_box", function() { return KupBox; });
...
/* harmony import */ var _chunk_8cdcd574_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chunk-8cdcd574.js */ "./src/assets/dist/esm/legacy/chunk-8cdcd574.js");
...
var KupBox = /** @class */ (function () {
    function KupBox(hostRef) {
        ...
        this.rows = [];
        this.filteredRows = [];
        this.kupBoxClicked = Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "kupBoxClicked", 6);
        this.kupBoxSelected = Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "kupBoxSelected", 6);
        this.kupAutoBoxSelect = Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "kupAutoBoxSelect", 6);
        this.kupRowActionMenuClicked = Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "kupRowActionMenuClicked", 6);
    ...
    KupBox.prototype.initRows = function () {
        ...
        if (this.filterEnabled && this.globalFilterValue) {
            ...
            // filtering rows
            this.filteredRows = Object(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["f"])(this.filteredRows, null, this.globalFilterValue, columnNames);
        }
        this.rows = this.sortRows(this.filteredRows);
        if (this.pagination) {
            this.rows = Object(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["p"])(this.rows, this.currentPage, this.pageSize);
        }
    };
    KupBox.prototype.sortRows = function (rows) {
        ...
        if (this.sortBy) {
            ...
            sortedRows = Object(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["s"])(sortedRows, [sortObject]);
        }
        return sortedRows;
    };
    ...
    KupBox.prototype.renderRow = function (row) {
        ...
        var multiSel = null;
        if (this.multiSelection) {
            multiSel = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "box-selection" }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("input", { type: "checkbox", checked: isSelected, onClick: function (e) { return e.stopPropagation(); }, onChange: function () { return _this.onSelectionCheckChange(row); } })));
        }
        var rowObject = null;
        if (this.enableRowActions) {
            ...
            if (row.actions) {
                var actionItems = row.actions.map(function (item, index) {
                    ...
                    return (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("li", { tabindex: "0", onClick: function () { return _this.onRowActionClicked(row, item, index); } }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: iconClass }), Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "text" }, item.text)));
                });
                rowActionMenuContent = Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("ul", null, actionItems);
            }
            rowObject = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "row-actions-wrapper" }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "row-actions-toggler" }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("svg", { version: "1.1", width: "24", height: "24", viewBox: "0 0 24 24", onClick: function () { return _this.onRowAction(row); } }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("path", { d: "M12,16A2,2 0 0,1 14,18A2,2 0 0,1 12,20A2,2 0 0,1 10,18A2,2 0 0,1 12,16M12,10A2,2 0 0,1 14,12A2,2 0 0,1 12,14A2,2 0 0,1 10,12A2,2 0 0,1 12,10M12,4A2,2 0 0,1 14,6A2,2 0 0,1 12,8A2,2 0 0,1 10,6A2,2 0 0,1 12,4Z" })), Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: menuClass }, rowActionMenuContent))));
        }
        var badges = null;
        if (row.badges && row.badges.length > 0) {
            badges = row.badges.map(function (badge) { return (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-badge", { text: badge.text, position: badge.position, icon: badge.icon, class: "centered" })); });
        }
        var boxClass = {
            box: true,
        ...
        return (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "box-wrapper" }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: boxClass, onClick: function (e) { return _this.onBoxClick(e, row); } }, multiSel, boxContent, badges), rowObject));
    };
    KupBox.prototype.renderSection = function (section, parent, row, visibleColumns) {
        ...
        if (section.collapsible) {
            ...
            sectionContainer = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: sectionClass, style: sectionStyle }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: contentClass }, sectionContent), Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "header", role: "button", onClick: function (e) {
                    e.stopPropagation();
                    _this.toggleSectionExpand(row, section);
                } }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "header-content" }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", null, headerTitle), Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "mdi mdi-chevron-down" })))));
        }
        else {
            var title = section.title ? Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("h3", null, section.title) : null;
            sectionContainer = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: sectionClass, style: sectionStyle }, title, sectionContent));
        }
    ...
    KupBox.prototype.renderBoxObject = function (boxObject, row, visibleColumns) {
        ...
        if (boxObject.value) {
            ...
            if (cell) {
                ...
                if (Object(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["b"])(cell.obj)) {
                    var badges = null;
                    if (cell.config && cell.config.badges) {
                        badges = cell.config.badges;
                    }
                    boContent = Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-image", { src: cell.value, badges: badges });
                }
                else if (Object(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["c"])(cell.obj)) {
                    boContent = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-button", Object.assign({}, Object(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["d"])(cell))));
                }
                else if (Object(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["e"])(cell.obj)) {
                    var value = Object(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["n"])(cell.value).value();
                    var hideLabel = false;
                    var labelText = null;
                    var wrapperStyle = {};
                    if (cell.config) {
                    ...
                    boContent = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { style: wrapperStyle }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-progress-bar", { value: value, labelText: labelText, hideLabel: hideLabel })));
                }
                else {
        ...
        return (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { "data-column": boxObject.column, class: "box-object", style: boStyle }, boContent));
    };
    KupBox.prototype.render = function () {
        ...
        if (this.sortEnabled) {
            ...
            sortPanel = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { id: "sort-panel" }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-combo", { displayedField: "value", items: items, initialValue: initialValue_1, onKetchupComboSelected: function (e) { return _this.onSortChange(e.detail); } })));
        }
        var filterPanel = null;
        if (this.filterEnabled) {
            filterPanel = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { id: "filter-panel" }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-text-input", { placeholder: "Cerca" // TODO
                ,
                onKetchupTextInputUpdated: function (event) { return _this.onGlobalFilterChange(event); } }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("svg", { slot: "left", version: "1.1", width: "18", height: "18", viewBox: "0 0 24 24" }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("path", { d: "M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z" })))));
        }
        var paginator = null;
        if (this.pagination) {
            paginator = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-paginator", { max: this.filteredRows.length, perPage: this.pageSize, currentPage: this.currentPage, onKupPageChanged: function (e) { return _this.handlePageChanged(e); }, mode: _chunk_8cdcd574_js__WEBPACK_IMPORTED_MODULE_3__["P"].SIMPLE }));
        }
        var boxContent = null;
        if (this.rows.length === 0) {
            boxContent = Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("p", { id: "empty-data-message" }, "Empty data");
        }
        else {
            var rows = this.rows;
        ...
        return (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, sortPanel, filterPanel, paginator, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { id: "box-container", style: containerStyle }, boxContent)));
    };
