            ...
            buttonsJsx = buttonsInGrid.map((btns) => {
                const btnsJsx = btns.map((btn) => {
                    ...
                    let cls = this.config.fillspace || !this.config.horizontal
                        ? 'fillspace'
                        : '';
                    return (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("td", null, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-button", { iconUrl: this.config.iconUrl, label: btn.value, iconClass: btn.iconClass, fillspace: this.config.fillspace, showtext: this.config.showtext, showicon: this.config.showicon, rounded: this.config.rounded, textmode: this.config.textmode, transparent: this.config.transparent, buttonClass: btnClass, flat: this.config.flat, "data-id": id++, onKupButtonClicked: (ev) => this.onBtnClicked(ev), align: this.config.align, class: cls })));
                });
...
class KupButton {
    ...
    render() {
        ...
        return [
            ...
            Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", { type: "button", class: btnClass, title: title, onClick: () => this.onBtnClickedHandler() }, icon, btnLabel),
        ];
    }
    get ketchupButtonEl() { return Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["g"])(this); }
...
class KupCheckbox {
    ...
    //---- Lifecycle hooks ----
    render() {
        return (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["H"], { onFocus: this.onHostFocus.bind(this) }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "kup-checkbox" }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("input", { ref: (el) => this.checkbox = el, "aria-label": this.label ? this.label : null, checked: this.checked, disabled: this.disabled, tabindex: this.setTabIndex, type: "checkbox", onBlur: this.onCheckboxBlur.bind(this), onChange: this.onCheckboxChange.bind(this), onFocus: this.onCheckboxFocus.bind(this) }), Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "kup-checkbox__check" }))));
    }
...
class KupCombo {
    ...
    composeList() {
        ...
        return (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: this.baseClass +
            ...
            .map((item) => (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("li", { onClick: () => this.onItemSelected(item) }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", null, item[this.displayedField])))))));
    }
    render() {
        ...
        return [
            Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: containerClass +
                    (this.isClearable
                        ...
                        : ''), ref: (el) => (this.comboText = el) }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: this.baseClass + '__current-value', onClick: this.onComboClick.bind(this) }, this.selected ? this.selected[this.displayedField] : '', Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("svg", { class: this.baseClass +
                    '__icon ' +
                    this.baseClass +
                    '__chevron' +
                    (this.isOpen
            ...
            this.usePortal ? (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-portal", { isVisible: this.isOpen, mirroredCssVars: this.internalCssVars, nodes: this.composeList(), portalParentRef: this.comboEl, ref: (el) => (this.portalRef = el),
    ...
    get comboEl() { return Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["g"])(this); }
...
class KupPortalInstance {
    ...
    get port() { return Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["g"])(this); }
...
class KupRadio {
    ...
    radioElementsComposer() {
        return this.items.map((radio) => {
            ...
            return Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("li", { class: 'kup-radio__item' + (this.selectedRadio && this.selectedRadio[this.valueField] === radio[this.valueField] ? ' kup-radio__item--selected' : '') }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("input", { id: uId, type: "radio", name: this.radioName, value: radio[this.valueField], onChange: this.onRadioChanged.bind(this, radio) })), Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("label", { htmlFor: uId }, radio[this.displayedField]));
        });
    }
    render() {
