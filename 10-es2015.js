...
/* harmony import */ var _chunk_8cdcd574_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chunk-8cdcd574.js */ "./src/assets/dist/esm/chunk-8cdcd574.js");
...
class KupBox {
    ...
    renderRow(row) {
        ...
        let multiSel = null;
        if (this.multiSelection) {
            multiSel = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "box-selection" }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("input", { type: "checkbox", checked: isSelected, onClick: (e) => e.stopPropagation(), onChange: () => this.onSelectionCheckChange(row) })));
        }
        let rowObject = null;
        ...
        return (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "box-wrapper" }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: boxClass, onClick: (e) => this.onBoxClick(e, row) }, multiSel, boxContent, badges), rowObject));
    }
    renderSection(section, parent, row, visibleColumns) {
        ...
        if (section.collapsible) {
            ...
            sectionContainer = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: sectionClass, style: sectionStyle }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: contentClass }, sectionContent), Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "header", role: "button", onClick: (e) => {
                    e.stopPropagation();
            ...
            const title = section.title ? Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("h3", null, section.title) : null;
        ...
        if (boxObject.value) {
            ...
            if (cell) {
                ...
                if (Object(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["b"])(cell.obj)) {
                    ...
                    const value = Object(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["n"])(cell.value).value();
                    let hideLabel = false;
                    let labelText = null;
                    const wrapperStyle = {};
                    if (cell.config) {
    ...
    render() {
        ...
        if (this.sortEnabled) {
            ...
            sortPanel = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { id: "sort-panel" }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-combo", { displayedField: "value", items: items, initialValue: initialValue, onKetchupComboSelected: (e) => this.onSortChange(e.detail) })));
        }
        ...
        if (this.filterEnabled) {
            filterPanel = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { id: "filter-panel" }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-text-input", { placeholder: "Cerca" // TODO
                ,
                onKetchupTextInputUpdated: (event) => this.onGlobalFilterChange(event) }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("svg", { slot: "left", version: "1.1", width: "18", height: "18", viewBox: "0 0 24 24" }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("path", { d: "M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z" })))));
        }
        let paginator = null;
        if (this.pagination) {
            paginator = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-paginator", { max: this.filteredRows.length, perPage: this.pageSize, currentPage: this.currentPage, onKupPageChanged: (e) => this.handlePageChanged(e), mode: _chunk_8cdcd574_js__WEBPACK_IMPORTED_MODULE_3__["P"].SIMPLE }));
        }
        let boxContent = null;
