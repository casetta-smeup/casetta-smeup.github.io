...
class KupDataTable {
    ...
    filterRows() {
        this.rows = Object(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["f"])(this.getRows(), this.filters, this.globalFilterValue, this.getVisibleColumns().map((c) => c.name));
    }
    isGrouping() {
    ...
    onColumnSort({ ctrlKey }, columnName) {
        ...
        if (i < this.sort.length) {
            ...
            const sortObj = this.sort[i];
            const newSortObj = Object.assign({}, sortObj, { sortMode: sortObj.sortMode === _chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["S"].A ? _chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["S"].D : _chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["S"].A });
            if (ctrlKey) {
    ...
    renderHeader() {
        ...
        const dataColumns = this.getVisibleColumns().map((column) => {
            ...
            if (this.showFilters) {
                ...
                filter = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { onMouseEnter: () => this.onColumnMouseLeave(column.name), onMouseLeave: () => this.onColumnMouseEnter(column.name) }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-text-input", { class: "datatable-filter", initialValue: filterValue, "data-col": column.name, onKetchupTextInputUpdated: (e) => {
            ...
            let sort = null;
            if (this.sortEnabled) {
                sort = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "column-sort", onMouseEnter: () => this.onColumnMouseLeave(column.name), onMouseLeave: () => this.onColumnMouseEnter(column.name) }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { role: "button", "aria-label": "Sort column" // TODO
                    ,
            ...
            columnMenuItems.push(Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("li", { role: "menuitem", onClick: () => this.switchColumnGroup(group, column.name) }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "mdi mdi-book" }), groupLabel));
            columnMenuItems.push(Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("li", { role: "menuitem", onClick: () => this.kupAddColumn.emit({ column: column.name }) }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "mdi mdi-table-column-plus-after" }), "Aggiungi colonna"));
            let columnMenu = null;
            ...
            if (this.enableSortableColumns) {
                ...
                dragHandlers = {
                    ...
                    onDrop: (e) => {
                        if (e.dataTransfer.types.indexOf(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["K"]) >= 0) {
                            const transferredData = JSON.parse(e.dataTransfer.getData(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["K"]));
                            e.preventDefault();
                            e.target.removeAttribute(this.dragOverAttribute);
        ...
        if (this.multiSelection) {
            ...
            multiSelectColumn = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("th", { style: style }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("input", { type: "checkbox", onChange: (e) => this.onSelectAll(e), title: `selectedRow: ${this.selectedRows.length} - renderedRows: ${this.renderedRows.length}`, checked: this.selectedRows.length > 0 &&
    ...
    renderFooter() {
        ...
        const footerCells = this.getVisibleColumns().map(({ name }) => (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("td", null, this.footer[name])));
        ...
        const footer = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("tfoot", null, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("tr", null, selectRowCell, groupingCell, footerCells)));
        return footer;
    }
    renderRow(row, level = 0, previousRow) {
        ...
        if (row.group) {
            ...
            if (this.hasTotals()) {
                ...
                jsxRows.push(Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("tr", { class: "group", onClick: () => this.onRowExpand(row) }, cells));
            }
            else {
                jsxRows.push(Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("tr", { class: "group", onClick: () => this.onRowExpand(row) }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("td", { colSpan: this.calculateColspan() }, indent, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { role: "button", "aria-label": "Row expander" // TODO change this label
                    ,
            ...
            const cells = visibleColumns.map((currentColumn, index) => {
                ...
                if (cell.options &&
                    ...
                    options = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "options", role: "button", "aria-label": "Opzioni oggetto", title: "Opzioni oggetto", onClick: () => this.onOptionClicked(name, row) }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("i", { class: "mdi mdi-settings" })));
                }
            ...
            let selectRowCell = null;
            if (this.multiSelection) {
                selectRowCell = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("td", null, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("input", { type: "checkbox", checked: this.selectedRows.includes(row), onClick: (e) => e.stopPropagation(), onChange: (e) => this.onRowCheckboxSelection(e, row) })));
            }
            let groupingCell = null;
            if (this.isGrouping() && this.hasTotals()) {
                groupingCell = Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("td", null);
            ...
            if (this.hasRowActions()) {
                ...
                if (row.actions) {
                    ...
                    // adding expander
                    rowActionExpander = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { title: "Espandi voci", class: `row-action mdi mdi-chevron-right`, onClick: (e) => this.onRowActionExpanderClick(e, row), role: "button", "aria-label": "Espandi voci", "aria-pressed": "false" }));
                }
            ...
            return (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("tr", { class: rowClass, onClick: (e) => this.onRowClick(e, row) }, selectRowCell, groupingCell, rowActionsCell, cells));
        }
    }
    renderActions(actions, row, type) {
        return actions.map((action, index) => {
            return (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { title: action.text, class: `row-action ${action.icon}`, onClick: (e) => this.onDefaultRowActionClick(e, {
                    action,
                    index,
                    row,
                    type,
    ...
    renderLoadMoreButton(isSlotted = true) {
        ...
        return (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", { "aria-label": label, class: "load-more-records mdi mdi-plus-circle", role: "button", slot: isSlotted ? 'more-results' : null, tabindex: "0", title: label, onClick: () => this.onLoadMoreClick() }));
    }
    render() {
        // resetting rows
        this.renderedRows = [];
        ...
        if (this.globalFilter) {
            globalFilter = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { id: "globalFilter" }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-text-input", { label: "Global filter", onKetchupTextInputUpdated: (event) => this.onGlobalFilterChange(event) })));
        }
        ...
        if (_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["P"].TOP === this.paginatorPos ||
            ...
            paginatorTop = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-paginator", { id: "top-paginator", max: this.rows.length, perPage: this.rowsPerPage, selectedPerPage: this.currentRowsPerPage, currentPage: this.currentPage, onKupPageChanged: (e) => this.handlePageChanged(e), onKupRowsPerPageChanged: (e) => this.handleRowsPerPageChanged(e) }, this.showLoadMore ? this.renderLoadMoreButton() : null));
        }
        let paginatorBottom = null;
        if (_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["P"].BOTTOM === this.paginatorPos ||
            _chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["P"].BOTH === this.paginatorPos) {
            paginatorBottom = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-paginator", { id: "bottom-paginator", max: this.rows.length, perPage: this.rowsPerPage, selectedPerPage: this.currentRowsPerPage, currentPage: this.currentPage, onKupPageChanged: (e) => this.handlePageChanged(e), onKupRowsPerPageChanged: (e) => this.handleRowsPerPageChanged(e) }, this.showLoadMore ? this.renderLoadMoreButton() : null));
        }
        let groupChips = null;
        if (this.isGrouping()) {
            const chips = this.groups.map((group) => {
                const column = Object(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["g"])(this.getColumns(), group.column);
                if (column) {
                    return (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "group-chip", tabIndex: 0, onClick: () => this.removeGroup(group) }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "mdi mdi-close-circle" }), column.title));
                }
                else {
                    return null;
                }
        ...
        const densityPanel = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { id: "density-panel" }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-button", { class: { active: this.density === 'small' }, iconClass: "mdi mdi-format-align-justify", onClick: () => (this.density = 'small') }), Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-button", { class: { active: this.density === 'medium' }, iconClass: "mdi mdi-menu", onClick: () => (this.density = 'medium') }), Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-button", { class: { active: this.density === 'big' }, iconClass: "mdi mdi-view-sequential", onClick: () => (this.density = 'big') })));
        const tableClass = {
        ...
        return (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { id: "data-table-wrapper" }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "above-wrapper" }, paginatorTop, globalFilter, densityPanel), Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "below-wrapper" }, groupChips, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("table", { class: tableClass }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("thead", { hidden: !this.showHeader, ref: (el) => (this.theadRef = el) }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("tr", null, header)), Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("tbody", null, rows), footer)), paginatorBottom));
    }
