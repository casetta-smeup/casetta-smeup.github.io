...
/*!************************************************************!*\
  !*** ./src/assets/dist/esm/legacy/kup-data-table.entry.js ***!
  \************************************************************/
/*! exports provided: kup_data_table */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "kup_data_table", function() { return KupDataTable; });
/* harmony import */ var _chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chunk-1851c479.js */ "./src/assets/dist/esm/legacy/chunk-1851c479.js");
/* harmony import */ var _chunk_d8060b98_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chunk-d8060b98.js */ "./src/assets/dist/esm/legacy/chunk-d8060b98.js");
/* harmony import */ var _chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chunk-621f9806.js */ "./src/assets/dist/esm/legacy/chunk-621f9806.js");
...
var KupDataTable = /** @class */ (function () {
    function KupDataTable(hostRef) {
         ...
         * @see loadMoreLimit
         */
        this.loadMoreMode = _chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["L"].PROGRESSIVE_THRESHOLD;
        this.paginatorPos = _chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["P"].TOP;
        this.rowsPerPage = 10;
        /**
        ...
        this.showGrid = _chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["h"].COMPLETE;
        /**
        ...
        this.kupAutoRowSelect = Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "kupAutoRowSelect", 6);
        this.kupRowSelected = Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "kupRowSelected", 6);
        this.kupOptionClicked = Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "kupOptionClicked", 6);
        this.kupAddColumn = Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "kupAddColumn", 6);
        this.kupRowActionClicked = Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "kupRowActionClicked", 6);
        this.kupLoadMoreClicked = Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "kupLoadMoreClicked", 6);
        this.kupCellButtonClicked = Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "kupCellButtonClicked", 6);
        this.kupDataTableSortedColumn = Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "kupDataTableSortedColumn", 6);
    }
    ...
    KupDataTable.prototype.initRows = function () {
        this.filterRows();
        this.footer = Object(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["j"])(this.rows, this.totals);
        this.groupRows();
        this.sortRows();
        this.paginatedRows = Object(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["p"])(this.rows, this.currentPage, this.currentRowsPerPage);
    };
    KupDataTable.prototype.filterRows = function () {
        this.rows = Object(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["f"])(this.getRows(), this.filters, this.globalFilterValue, this.getVisibleColumns().map(function (c) { return c.name; }));
    };
    ...
    KupDataTable.prototype.onColumnSort = function (_a, columnName) {
        ...
        if (i < this.sort.length) {
            ...
            var sortObj = this.sort[i];
            var newSortObj = Object.assign({}, sortObj, { sortMode: sortObj.sortMode === _chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["S"].A ? _chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["S"].D : _chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["S"].A });
            if (ctrlKey) {
            ...
            var sortObj = {
                column: columnName,
                sortMode: _chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["S"].A,
            };
    ...
    KupDataTable.prototype.groupRows = function () {
        ...
        this.rows = Object(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["k"])(this.getColumns(), this.rows, this.groups, this.totals);
    ...
    KupDataTable.prototype.onLoadMoreClick = function () {
        ...
        switch (this.loadMoreMode) {
            case _chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["L"].CONSTANT:
                loadItems = this.loadMoreStep;
                break;
            case _chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["L"].CONSTANT_INCREMENT:
                loadItems = this.loadMoreStep * (this.loadMoreEventCounter + 1);
                break;
            case _chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["L"].PROGRESSIVE_THRESHOLD:
                loadItems =
    ...
    KupDataTable.prototype.sortRows = function () {
        this.rows = Object(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["s"])(this.rows, this.sort);
    };
    ...
    KupDataTable.prototype.renderHeader = function () {
        ...
        var dataColumns = this.getVisibleColumns().map(function (column) {
            ...
            if (_this.showFilters) {
                ...
                filter = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { onMouseEnter: function () { return _this.onColumnMouseLeave(column.name); }, onMouseLeave: function () { return _this.onColumnMouseEnter(column.name); } }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-text-input", { class: "datatable-filter", initialValue: filterValue, "data-col": column.name, onKetchupTextInputUpdated: function (e) {
            ...
            if (_this.sortEnabled) {
                sort = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "column-sort", onMouseEnter: function () { return _this.onColumnMouseLeave(column.name); }, onMouseLeave: function () { return _this.onColumnMouseEnter(column.name); } }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { role: "button", "aria-label": "Sort column" // TODO
                    ,
            ...
            columnMenuItems.push(Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("li", { role: "menuitem", onClick: function () { return _this.switchColumnGroup(group, column.name); } }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "mdi mdi-book" }), groupLabel));
            columnMenuItems.push(Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("li", { role: "menuitem", onClick: function () { return _this.kupAddColumn.emit({ column: column.name }); } }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "mdi mdi-table-column-plus-after" }), "Aggiungi colonna"));
            var columnMenu = null;
            if (columnMenuItems.length !== 0) {
                var menuClass = _this.openedMenu === column.name ? 'open' : 'closed';
                columnMenu = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "column-menu " + menuClass }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("ul", { role: "menubar" }, columnMenuItems)));
            }
            ...
            if (_this.enableSortableColumns) {
                ...
                dragHandlers = {
                    ...
                    onDragStart: function (e) {
                        ...
                        e.dataTransfer.setData(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["K"], JSON.stringify(column));
                    ...
                    onDragLeave: function (e) {
                        if (e.dataTransfer.types.indexOf(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["K"]) >= 0) {
                    ...
                    onDrop: function (e) {
                        if (e.dataTransfer.types.indexOf(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["K"]) >= 0) {
                            var transferredData = JSON.parse(e.dataTransfer.getData(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["K"]));
                            e.preventDefault();
                            e.target.removeAttribute(_this.dragOverAttribute);
            ...
            return (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("th", Object.assign({ style: thStyle, onMouseEnter: function () { return _this.onColumnMouseEnter(column.name); }, onMouseLeave: function () { return _this.onColumnMouseLeave(column.name); } }, dragHandlers), Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "column-title" }, column.title), sort, filter, columnMenu));
        });
        ...
        if (this.multiSelection) {
            ...
            multiSelectColumn = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("th", { style: style }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("input", { type: "checkbox", onChange: function (e) { return _this.onSelectAll(e); }, title: "selectedRow: " + this.selectedRows.length + " - renderedRows: " + this.renderedRows.length, checked: this.selectedRows.length > 0 &&
                    this.selectedRows.length ===
                        this.renderedRows.length })));
        }
        var groupColumn = null;
        if (this.isGrouping() && this.hasTotals()) {
            groupColumn = Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("th", null);
        }
        var actionsColumn = null;
        if (this.hasRowActions()) {
            actionsColumn = Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("th", null);
        }
    ...
    KupDataTable.prototype.renderFooter = function () {
        ...
        var footerCells = this.getVisibleColumns().map(function (_a) {
            var name = _a.name;
            return (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("td", null, _this.footer[name]));
        });
        var selectRowCell = null;
        if (this.multiSelection) {
            selectRowCell = Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("td", null);
        }
        var groupingCell = null;
        if (this.isGrouping() && this.hasTotals()) {
            groupingCell = Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("td", null);
        }
        var footer = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("tfoot", null, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("tr", null, selectRowCell, groupingCell, footerCells)));
        return footer;
    };
    KupDataTable.prototype.renderRow = function (row, level, previousRow) {
        ...
        if (row.group) {
            ...
            for (var i = 0; i < level; i++) {
                indent.push(Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "indent" }));
            }
            if (this.hasTotals()) {
                var cells = [];
                // adding 'grouping' cell
                var colSpan = this.multiSelection ? 2 : 1;
                cells.push(Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("td", { colSpan: colSpan }, indent, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { role: "button", "aria-label": "Row expander" // TODO change this label
                    ,
                ...
                for (var _i = 0, visibleColumns_1 = visibleColumns; _i < visibleColumns_1.length; _i++) {
                    ...
                    cells.push(Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("td", { class: "total" }, row.group.totals[column.name]));
                }
                jsxRows_1.push(Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("tr", { class: "group", onClick: function () { return _this.onRowExpand(row); } }, cells));
            }
            else {
                jsxRows_1.push(Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("tr", { class: "group", onClick: function () { return _this.onRowExpand(row); } }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("td", { colSpan: this.calculateColspan() }, indent, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { role: "button", "aria-label": "Row expander" // TODO change this label
                    ,
            ...
            var cells = visibleColumns.map(function (currentColumn, index) {
                ...
                if (index === 0 && !(_this.isGrouping() && _this.hasTotals())) {
                    for (var i = 0; i < level; i++) {
                        indend.push(Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "indent" }));
                    }
                }
                ...
                if (cell.options &&
                    ...
                    options = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "options", role: "button", "aria-label": "Opzioni oggetto", title: "Opzioni oggetto", onClick: function () { return _this.onOptionClicked(name, row); } }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("i", { class: "mdi mdi-settings" })));
                }
                ...
                // The previous value must be passed only if repeated values can be hidden and we have a previous row.
                {
                    ...
                    : null);
                var cellClass = {
                    number: Object(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["i"])(cell.obj),
                };
                var cellStyle = null;
                if (!_this.styleHasBorderRadius(cell)) {
                    cellStyle = cell.style;
                }
                return (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("td", { "data-column": name, style: cellStyle, class: cellClass }, indend, jsxCell, options));
            });
            var selectRowCell = null;
            if (this.multiSelection) {
                selectRowCell = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("td", null, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("input", { type: "checkbox", checked: this.selectedRows.includes(row), onClick: function (e) { return e.stopPropagation(); }, onChange: function (e) { return _this.onRowCheckboxSelection(e, row); } })));
            }
            var groupingCell = null;
            if (this.isGrouping() && this.hasTotals()) {
                groupingCell = Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("td", null);
            ...
            if (this.hasRowActions()) {
                ...
                if (row.actions) {
                    ...
                    // adding expander
                    rowActionExpander = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { title: "Espandi voci", class: "row-action mdi mdi-chevron-right", onClick: function (e) { return _this.onRowActionExpanderClick(e, row); }, role: "button", "aria-label": "Espandi voci", "aria-pressed": "false" }));
                }
                rowActionsCell = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("td", null, defaultRowActions, rowActionExpander, variableActions));
            }
            var rowClass = {
                selected: this.selectedRows.includes(row),
            };
            return (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("tr", { class: rowClass, onClick: function (e) { return _this.onRowClick(e, row); } }, selectRowCell, groupingCell, rowActionsCell, cells));
        }
    };
    KupDataTable.prototype.renderActions = function (actions, row, type) {
        var _this = this;
        return actions.map(function (action, index) {
            return (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { title: action.text, class: "row-action " + action.icon, onClick: function (e) { return _this.onDefaultRowActionClick(e, {
                    action: action,
                    index: index,
                    row: row,
                    type: type,
    ...
    KupDataTable.prototype.renderCell = function (cell, column, cellData, previousRowCellValue) {
        ...
        if (Object(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["l"])(cell.obj) || Object(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["o"])(cell.obj)) {
            content = Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: valueToDisplay });
        }
        else if (Object(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["b"])(cell.obj)) {
            content = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("img", { src: valueToDisplay, alt: "", width: "64", height: "64" }));
        }
        else if (Object(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["q"])(cell.obj)) {
            content = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("a", { href: valueToDisplay, target: "_blank" }, valueToDisplay));
        }
        else if (Object(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["r"])(cell.obj)) {
            content = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-checkbox", { checked: !!cell.obj.k, disabled: cellData &&
                    cellData.row &&
                    cellData.row.hasOwnProperty('readOnly')
                    ? cellData.row.readOnly
                    : true }));
        }
        else if (Object(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["c"])(cell.obj)) {
            /**
             ...
             */
            content = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-button", Object.assign({}, Object(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["d"])(cell), { onKupButtonClicked: this.onJ4btnClicked.bind(this, cellData ? cellData.row : null, cellData ? cellData.column : null, cell) })));
        }
        else if (Object(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["t"])(cell.obj)) {
            var props = {
                value: cell.value,
            };
            ...
            content = valueToDisplay ? Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-graphic-cell", Object.assign({}, props)) : null;
        }
        // TODO
        ...
        return (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "cell-content", style: style }, content));
    };
    KupDataTable.prototype.renderLoadMoreButton = function (isSlotted) {
        ...
        return (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", { "aria-label": label, class: "load-more-records mdi mdi-plus-circle", role: "button", slot: isSlotted ? 'more-results' : null, tabindex: "0", title: label, onClick: function () { return _this.onLoadMoreClick(); } }));
    };
    KupDataTable.prototype.render = function () {
        ...
        if (this.paginatedRows.length === 0) {
            rows = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("tr", null, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("td", { colSpan: this.calculateColspan() }, "Empty data")));
        }
        else {
            rows = [];
            this.paginatedRows
        ...
        if (this.globalFilter) {
            globalFilter = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { id: "globalFilter" }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-text-input", { label: "Global filter", onKetchupTextInputUpdated: function (event) { return _this.onGlobalFilterChange(event); } })));
        }
        var paginatorTop = null;
        if (_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["P"].TOP === this.paginatorPos ||
            _chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["P"].BOTH === this.paginatorPos) {
            paginatorTop = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-paginator", { id: "top-paginator", max: this.rows.length, perPage: this.rowsPerPage, selectedPerPage: this.currentRowsPerPage, currentPage: this.currentPage, onKupPageChanged: function (e) { return _this.handlePageChanged(e); }, onKupRowsPerPageChanged: function (e) { return _this.handleRowsPerPageChanged(e); } }, this.showLoadMore ? this.renderLoadMoreButton() : null));
        }
        var paginatorBottom = null;
        if (_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["P"].BOTTOM === this.paginatorPos ||
            _chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["P"].BOTH === this.paginatorPos) {
            paginatorBottom = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-paginator", { id: "bottom-paginator", max: this.rows.length, perPage: this.rowsPerPage, selectedPerPage: this.currentRowsPerPage, currentPage: this.currentPage, onKupPageChanged: function (e) { return _this.handlePageChanged(e); }, onKupRowsPerPageChanged: function (e) { return _this.handleRowsPerPageChanged(e); } }, this.showLoadMore ? this.renderLoadMoreButton() : null));
        }
        var groupChips = null;
        if (this.isGrouping()) {
            var chips = this.groups.map(function (group) {
                var column = Object(_chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["g"])(_this.getColumns(), group.column);
                if (column) {
                    return (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "group-chip", tabIndex: 0, onClick: function () { return _this.removeGroup(group); } }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "mdi mdi-close-circle" }), column.title));
                }
                else {
                    return null;
                }
            });
            groupChips = Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { id: "group-chips" }, chips);
        }
        var densityPanel = (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { id: "density-panel" }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-button", { class: { active: this.density === 'small' }, iconClass: "mdi mdi-format-align-justify", onClick: function () { return (_this.density = 'small'); } }), Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-button", { class: { active: this.density === 'medium' }, iconClass: "mdi mdi-menu", onClick: function () { return (_this.density = 'medium'); } }), Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("kup-button", { class: { active: this.density === 'big' }, iconClass: "mdi mdi-view-sequential", onClick: function () { return (_this.density = 'big'); } })));
        var tableClass = {
            'column-separation': _chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["h"].COMPLETE === this.showGrid ||
                _chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["h"].COL === this.showGrid,
            'row-separation': _chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["h"].COMPLETE === this.showGrid ||
                _chunk_621f9806_js__WEBPACK_IMPORTED_MODULE_2__["h"].ROW === this.showGrid,
            'persistent-header': this.headerIsPersistent,
        };
        tableClass["density-" + this.density] = true;
        return (Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { id: "data-table-wrapper" }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "above-wrapper" }, paginatorTop, globalFilter, densityPanel), Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "below-wrapper" }, groupChips, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("table", { class: tableClass }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("thead", { hidden: !this.showHeader, ref: function (el) { return (_this.theadRef = el); } }, Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("tr", null, header)), Object(_chunk_1851c479_js__WEBPACK_IMPORTED_MODULE_0__["h"])("tbody", null, rows), footer)), paginatorBottom));
    };
